...
export function InputSearch({focusArea, value, onChangeText, placeholderText}) {
    ...
    return (
        <TouchableOpacity onPress={() => focusInput({focusArea})} activeOpacity={opacity.opacity800}>
